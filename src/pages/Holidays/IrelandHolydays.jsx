...
const IrelandHolydays = () => {
    ...
    const ireHolidays = holidayInfo["northern-ireland"]?.events;

    const filteredDate = ireHolidays?.filter(data => data.date >= format(dateRange[0].startDate, 'yyyy-MM-dd') && data.date <= format(dateRange[0].endDate, 'yyyy-MM-dd'));
    ...
    return (
        <>
            ...
            <div className="container mx-auto py-20">
                <h2 className="text-3xl font-bold pt-10 pb-14">Get Bank Holidays info for: Northern Ireland</h2>
                <div className="">
...
export default IrelandHolydays;