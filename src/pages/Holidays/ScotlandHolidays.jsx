...
const ScotlandHolidays = () => {
    ...
    const scotHolidays = holidayInfo.scotland?.events;
    // console.log(scotHolidays);

    const filteredDate = scotHolidays?.filter(data => data.date >= format(dateRange[0].startDate, 'yyyy-MM-dd') && data.date <= format(dateRange[0].endDate, 'yyyy-MM-dd'));
    ...
    return (
        <>
            ...
            <div className="container mx-auto py-20 overflow-x-auto">
                <h2 className="text-3xl font-bold pt-10 pb-14">Get Bank Holidays info for: Scotland</h2>
                <div className="">
...
export default ScotlandHolidays;
